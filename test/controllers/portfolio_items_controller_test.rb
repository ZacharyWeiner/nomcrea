...
class PortfolioItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create portfolio_item" do
    assert_difference('PortfolioItem.count') do
      post portfolio_items_url, params: { portfolio_item: { cover_image: @portfolio_item.cover_image, description: @portfolio_item.description, portfolio_id: @portfolio_item.portfolio_id, title: @portfolio_item.title } }
    end
  ...
  test "should update portfolio_item" do
    patch portfolio_item_url(@portfolio_item), params: { portfolio_item: { cover_image: @portfolio_item.cover_image, description: @portfolio_item.description, portfolio_id: @portfolio_item.portfolio_id, title: @portfolio_item.title } }
