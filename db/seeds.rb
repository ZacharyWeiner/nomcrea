...
nomCrea2 = User.create!(email: 'creative2@nomcrea.com', password: 'password', password_confirmation: 'password')
puts "User Created: creative2@nomcrea.com"
nomCrea2Portfolio1 = Portfolio.create!(title: 'nomCrea2 - Photography', user: nomCrea1)
...
nomCrea2.portfolios << nomCrea1Portfolio1
puts 'Portfolio Items Created For User: creative2@nomcrea.com Portfolio 1'

nomCrea2Portfolio2 = Portfolio.create!(title: 'nomCrea2 - Videography', user: nomCrea1)
